...
const routes: RouteConfig[] = [
  {
    ...
    children: [
      ...
      { path: '/other-settings', meta: 'settings', component: () => import('pages/setting/SubSetting.index.vue'),
        children: [
          { path: '/', meta: 'settings', component: () => import('pages/setting/sub-setting/category/Category.index.vue') },
          { path: '/other-settings/sub-categories', meta: 'settings', component: () => import('pages/setting/sub-setting/sub-category/SubCategory.index.vue') },
          { path: '/other-settings/brands', meta: 'settings', component: () => import('pages/setting/sub-setting/brand/Brand.index.vue') },
        ]
      },
    ]
  },
